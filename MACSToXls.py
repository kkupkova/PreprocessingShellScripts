...
#positive peaks come first in the text file - get every second item in the lists
#at the ene and odd positions:
positive_peaks = peaks[0::2]
negative_peaks =  peaks[1::2]
...
df = DataFrame({'01 # processed sample': sample_ID,
                ...
                '03 # MACS peaks in treatment': map(int, positive_peaks),
                '04 # negative peaks': map(int, negative_peaks)})
