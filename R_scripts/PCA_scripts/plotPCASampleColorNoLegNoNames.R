...
plotPCAWSampleColorNoLegNoNames = function(x, intgroup="condition", ntop=500)
{
...
print(plotPCAWSampleColorNoLegNoNames(rld,intgroup=c("condition")))

#or this command, as appropriate 
print(plotPCAWSampleColorNoLegNoNames(vsd,intgroup=c("condition")))
