# use this script for computing background in "sparse" data such as H3K4me3 data in human cells; this script uses the bins with 1 or more reads (i.e. excludes the zero bins).  Compare the results using the script Fit_BkgrdRC_Exp.R which includes the zero bins.  To begin, set working directory to location of files, then use the following to spcify which file to analyze.
