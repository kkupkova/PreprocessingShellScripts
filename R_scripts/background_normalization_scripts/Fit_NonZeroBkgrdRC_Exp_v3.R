...
rc_filename <- "binned_52wk150-1409.txt"
#in the above, my_file.txt is in 3 column BED format and column 4 is the number of reads in each bin 
#after that, run the script beginning at line 10
args <- commandArgs(TRUE)
rc_filename <- args[1]
#as stated above, if specifying rc_filename <- "my_file" from the working directory, then run script beginning at line 10.
