#!/bin/bash
#This script will run macs using the specified 'test' and 'control' BAM or SAM files in the working directory. $1=test file, $2=control file, $3=output file prefix
